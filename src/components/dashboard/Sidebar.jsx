        ...
        <div className="flex items-center justify-between p-5 border-b border-dark-50">
          <Link href="/" className="flex items-center gap-2.5 group">
            ...
            <div>
              ...
              <div className="text-[9px] font-semibold text-gold-500 uppercase tracking-widest -mt-0.5">Admin</div>
            </div>
          </Link>
          <button onClick={onClose} className="lg:hidden p-1.5 rounded-lg hover:bg-dark-100 text-ink-400 transition">
            <X size={18} />
          </button>
        </div>
        ...
        <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
          ...
          {NAV_ITEMS.map((item) => {
            ...
            return (
              ...
              >
                <Icon size={17} className={active ? "text-brand-400" : "text-ink-400 group-hover:text-ink-200 transition"} />
        ...
        <div className="p-4 border-t border-dark-50">
          <div className="flex items-center gap-3 px-3 py-2.5 rounded-xl mb-2">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-semibold text-ink-100 truncate">{user?.name ?? "Usuário"}</p>
          ...
          >
            <LogOut size={17} className="transition" />
            Sair
          </button>
        </div>
      </aside>
